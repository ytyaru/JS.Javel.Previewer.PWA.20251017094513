...
//    constructor() {this._ = {elNms:{this:'loading', page:'loadingAllPage', rate:'loadingRate', percent:'loadingPercent', message:'loadingMessage'}, manuscript:null, page:{all:0, rate:0, percent:0}};}
    constructor() {this._ = {elNms:{this:'loading', page:'loadingAllPage', percent:'loadingPercent', message:'loadingMessage'}, manuscript:null, page:{all:0, rate:0, percent:0}};}
...
//    get rate() {return Dom.q(`[name="${this._.elNms.rate}"]`)}
    get percent() {return Dom.q(`[name="${this._.elNms.percent}"]`)}
        ...
        if (!this.el) {
            Dom.q(`[name="overlay"]`).append(
                Dom.tags.div({name:this._.elNms.this, style:'display:none; font-size:1.25em; color:var(--fg-color); background-color:var(--bg-color); border:8px ridge var(--fg-color);'}, 
                    ...
                    Dom.tags.span({name:this._.elNms.percent}, '0 %'),
